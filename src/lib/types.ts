...
export interface ProductAnalysisData {
  ...
  // costCalculableSalesCount: number; // Number of sale records for this product for which a cost could be calculated - REMOVED
...
export interface SalesProfitData extends ProductAnalysisData {
  ...
  // costingCoverage: string; // String indicating cost calculation coverage (e.g., "5/5" or "3/5") - REMOVED
}
